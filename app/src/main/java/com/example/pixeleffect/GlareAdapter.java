...
public class GlareAdapter extends BaseAdapter {
    ...
    public GlareAdapter(Context context2, ArrayList<Integer> stickers) {
        context = context2;
        collage = stickers;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(Integer.valueOf(((Integer) collage.get(position)).intValue())).override(width / 4, height / 7).into(img_editing);
        System.gc();
        return convertView;
    }
}
